...
class Buscador:
    ...
    def vamos_buscar(self):
        playlist = [Musica("Ponta de Areia", "Milton Nascimento", "Milton Nascimento", 1987),
                    Musica("Podres Poderes", "Caetano Veloso", "Caetano Veloso", 1989),
                    Musica("Baby", "Gal Costa", "Caetano Veloso", 1969)]
        
        onde_achou = self.busca_por_titulo(playlist, "Oi")
        if onde_achou == -1:
